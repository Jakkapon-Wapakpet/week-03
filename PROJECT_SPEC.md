...
* **บทบาทผู้ใช้ (Actors):**
  - **ลูกค้า (Customer / Guest):** สมัครสมาชิก, เข้าสู่ระบบ, ค้นหาและกรองสินค้า, เปรียบเทียบสเปกสินค้า (สูงสุด 3 รายการ), หยิบใส่ตะกร้า, กรอกที่อยู่จัดส่ง, ชำระเงิน (PromptPay สแกน QR / บัตรเครดิต-เดบิต)
  - **ผู้ดูแลระบบ (Admin):** เข้าสู่ระบบแอดมิน, จัดการข้อมูลสินค้า (เพิ่ม, ลบ, แก้ไขรายละเอียดและสเปกของเมาส์/คีย์บอร์ด/หูฟัง), จัดการคำสั่งซื้อของลูกค้า (ดูรายการสั่งซื้อ, อัปเดตสถานะการส่ง, บันทึกเลขติดตามพัสดุ)
